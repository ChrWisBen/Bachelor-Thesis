...
- Correlation heatmap:
    ...
    * SAVED AS SVG with "_RC" suffix
- PCA cumulative explained variance plot (TEAL) SAVED AS SVG with "_RC" suffix
- PC1 vs PC2 scatter SAVED AS SVG with "_RC" suffix
...
# Settings
# ---------------------------
excel_path = Path(r"C:\Users\ChristianWBendtsen\OneDrive - ABC\Skrivebord\Bachelor\RC_Wall_Cap_Samples\KunNorm_RC.xlsx")
sheet_name = 0
...
# ---- SVG names: current plot name + "_RC.svg" ----
def svg_name(stem):
    return out_dir / f"{stem}_RC.svg"
