...
CENTROID_K_CHOICE = {
    "P₁": {"W₁":"k_capacity_N200_RC", "W₂":"k_capacity_N200_RC",
           "W₃":"k_capacity_N200_RC",  "W₄":"k_capacity_N200_RC"},
    "P₂": {"W₁":"k_unit_RC", "W₂":"k_unit_RC", "W₃":"k_unit_RC", "W₄":"k_unit_RC"},
    "P₃": {"W₁":"k_shear_RC", "W₂":"k_shear_RC", "W₃":"k_shear_RC", "W₄":"k_shear_RC"},
    "P₄": {"W₁":"k_bend_RC", "W₂":"k_bend_RC", "W₃":"k_bend_RC", "W₄":"k_bend_RC"},
}
...
def plot_combined():
    ...
    ax.grid(True)
    plt.tight_layout()
    plt.savefig("rotational_centres_Unified_RC.svg", format="svg")
    plt.close(fig)
...
if __name__ == "__main__":
    # 1) P1,1 and P2,1  (H=4)
    pair1 = ("P1,1", "P2,1")
    title1 = "RC, H(v) = 0m – " + plain_to_display("P1,1") + "–" + plain_to_display("P2,1")
    plot_pair(pair1, "rotational_centres_P1_1_P2_1_RC.svg", title1)

    # 2) P1,2 and P2,2  (H=10)
    pair2 = ("P1,2", "P2,2")
    title2 = "RC, H(v) = 5m – " + plain_to_display("P1,2") + "–" + plain_to_display("P2,2")
    plot_pair(pair2, "rotational_centres_P1_2_P2_2_RC.svg", title2)

    # 3) P1,3 and P2,3  (H=20)
    pair3 = ("P1,3", "P2,3")
    title3 = "RC, H(v) = 10m – " + plain_to_display("P1,3") + "–" + plain_to_display("P2,3")
    plot_pair(pair3, "rotational_centres_P1_3_P2_3_RC.svg", title3)
