...
"""
Combined plot:
Plots P₁,₁ ... P₁,₄, P₂,₁ ... P₂,₄, P₃,₁ ... P₃,₄ and a single P₄ on one figure.
...
# Fourth table (you can replace this with real data if needed)
K_TABLES_4 = {
...
CENTROID_K_CHOICE = {
    ...
    # P₂: unit RC
    "P₂": {"W₁":"k_capacity_RC_V50", "W₂":"k_capacity_RC_V50", "W₃":"k_capacity_RC_V50", "W₄":"k_capacity_RC_V50"},
    # P₃: shear RC
    "P₃": {"W₁":"k_capacity_RC_V75", "W₂":"k_capacity_RC_V75", "W₃":"k_capacity_RC_V75", "W₄":"k_capacity_RC_V75"},
    # P₄: bending RC
    "P₄": {"W₁":"k_capacity_H0_RC", "W₂":"k_capacity_H0_RC", "W₃":"k_capacity_H0_RC", "W₄":"k_capacity_H0_RC"},
}
...
# P₄ only once, using the last scenario (K_TABLES_4)
kv_p4 = k_values_for_choice(CENTROID_K_CHOICE["P₄"], K_TABLES_4)
...
def plot_combined():
    ...
    ax.set_title("Rotational Centres, Unified Approach, RC",
                 fontsize=13, pad=10)
    ...
    ax.grid(True)
    plt.tight_layout()
    plt.savefig("rotational_centres_Unified_Only_RC.svg", format="svg")
    plt.show()
