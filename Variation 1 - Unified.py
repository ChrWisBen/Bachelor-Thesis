...
CENTROID_K_CHOICE = {
    "P₁": {"W₁":"k_capacity_N200_RC", "W₂":"k_capacity_N200_RC",
           "W₃":"k_capacity_N0_CLT",  "W₄":"k_capacity_N0_CLT"},
    "P₂": {"W₁":"k_unit_RC", "W₂":"k_unit_RC", "W₃":"k_unit_CLT", "W₄":"k_unit_CLT"},
    "P₃": {"W₁":"k_shear_RC", "W₂":"k_shear_RC", "W₃":"k_shear_CLT", "W₄":"k_shear_CLT"},
    "P₄": {"W₁":"k_bend_RC", "W₂":"k_bend_RC", "W₃":"k_bend_CLT", "W₄":"k_bend_CLT"},
}
...
def plot_combined():
    ...
    ax.set_title("Rotational Centres, Unified Approach, Variation 1",
                 fontsize=13, pad=10)
    ...
    ax.grid(True)
    plt.tight_layout()
    plt.savefig("rotational_centres_Unified_Variation1.svg", format="svg")
    plt.close(fig)
...
if __name__ == "__main__":
    # 1) P1,1 and P2,1  (H=4)
    pair1 = ("P1,1", "P2,1")
    title1 = "Variation 1, H(v) = 0m – " + plain_to_display("P1,1") + "–" + plain_to_display("P2,1")
    plot_pair(pair1, "rotational_centres_P1_1_P2_1_Variation1.svg", title1)

    # 2) P1,2 and P2,2  (H=10)
    pair2 = ("P1,2", "P2,2")
    title2 = "Variation 1, H(v) = 5m – " + plain_to_display("P1,2") + "–" + plain_to_display("P2,2")
    plot_pair(pair2, "rotational_centres_P1_2_P2_2_Variation1.svg", title2)

    # 3) P1,3 and P2,3  (H=20)
    pair3 = ("P1,3", "P2,3")
    title3 = "Variation 1, H(v) = 10m – " + plain_to_display("P1,3") + "–" + plain_to_display("P2,3")
    plot_pair(pair3, "rotational_centres_P1_3_P2_3_Variation1.svg", title3)
