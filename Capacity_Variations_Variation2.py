...
CENTROID_K_CHOICE = {
    ...
    "P₁": {"W₁":"k_capacity_CLT_V25", "W₂":"k_capacity_RC_V25",
           "W₃":"k_capacity_RC_V25", "W₄":"k_capacity_CLT_V25"},
    # P₂: capacity RC at V=50%
    "P₂": {"W₁":"k_capacity_CLT_V50", "W₂":"k_capacity_RC_V50",
           "W₃":"k_capacity_RC_V50", "W₄":"k_capacity_CLT_V50"},
    # P₃: capacity RC at V=75%
    "P₃": {"W₁":"k_capacity_CLT_V75", "W₂":"k_capacity_RC_V75",
           "W₃":"k_capacity_RC_V75", "W₄":"k_capacity_CLT_V75"},
    # P₄: capacity RC at V=100% (for H=5,10,20)
    "P₄": {"W₁":"k_capacity_CLT_V100", "W₂":"k_capacity_RC_V100",
           "W₃":"k_capacity_RC_V100", "W₄":"k_capacity_CLT_V100"},
}
...
def plot_combined():
    ...
    ax.set_title("Rotational Centres, Capacity Approach, Variation 2 - Differeing V, H",
                 fontsize=13, pad=10)
    ...
    ax.grid(True)
    plt.tight_layout()
    plt.savefig("rotational_centres_Capacity_Many_Variation2.svg", format="svg")
    plt.show()
