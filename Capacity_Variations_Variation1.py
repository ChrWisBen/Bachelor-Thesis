...
def plot_combined():
    ...
    ax.set_title("Rotational Centres, Capacity Approach, Variation 1 - Differeing V, H",
                 fontsize=13, pad=10)
    ...
    ax.grid(True)
    plt.tight_layout()
    plt.savefig("rotational_centres_Capacity_Many_Variation1.svg", format="svg")
    plt.show()
