...
# Settings (EDIT THESE)
# ---------------------------
excel_path = Path(r"C:\Users\ChristianWBendtsen\OneDrive - ABC\Skrivebord\Bachelor\RC_Wall_Cap_Samples\Reel værdi af forskydning.xlsx")  # <-- CHANGE
...
ax.set_xlabel(f"Value (grouped by {bin_width})")
